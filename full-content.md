...
*Noms péjoratifs pour les autres: esclaves, moutons, faux-dieux…*
...
- On compte le nombre de réussites d'un [camp](../mises) théiste de la manière suivante:
    - On compte les pairs
...
- Mode **affaibli**: pas d’effet des 6
- Mode **héroïque**: les pairs permettent de relancer les impairs

**Commentaires** 

- Le théiste cherche et trouve du soutien divin en rapport avec le domaine de son Dieu.
- Même une suite de 6 s'enchaînant sur une simple opposition avec un protagoniste de faible ampleur peut se traduire par l'impression d'être totalement aligné avec les principes du Dieu voire même l'obtention d’une révélation.

[Et pourquoi pas des cartes runiques?](runic-cards)
---
...
- On compte le nombre de réussites d'un [camp](../mises) logique de la manière suivante:
    - On somme et on divise par 5. Le résultat est le nombre de 5 entiers.

**Modes de puissance**

- Mode **affaibli**: on divise par 6
- Mode **héroïque**: on divise par 4 (voire 3 ou 2 ou 1…)

**Commentaires**

C'est rationnel. Il n’y a pas de notion qualitative pour déterminer pair/impair. Une simple addition.

C’est aussi le seul mode a ne pas voir les pairs comme des réussites. Comme si on devait surtout compter sur nous même. Le Dieu est Invisible. 

C’est une magie plus créative que les théistes (cadre plus ouvert mais en théorie seulement car les Écoles Monothéistes ont un peu figé certaines choses)

Un peu comme les animistes, la préparation est importante pour maximiser leurs chances et avoir plus de mises. 
...
Il s’agit en fait d’un cas particulier d’une opposition avec une partie mystique. 

Et l’Illumination peut émerger naturellement dans une configuration de dés très spécifiques.

L’idée sous-jacente, c’est que l’autre comprend (voire même se met a jouer les 1 de manière mystique) pour remporter la victoire ou arriver a égalité. Les configurations sont donc plus larges que les deux cas d’école présentés juste après. 

Exemples possibles:

### L’éclairante stupéfaction
...
> L’autre camp se retrouve en position de pouvoir jouer un coup mystique pour changer le résultat final. S’il le fait, il se rapproche ou épouse l’Illumination.

- Côté other, tirage: 1, 2, 3, 4, 5, 6 (21) (III, IV ou II)
- Côté mystique: 6, 1, 6, 1, 6, 1 (21) (III)
- Résultat:
    - Other: 1, 2, 3, 4, 5 (15) (II ou III)
    - Mystique: 6, 1, 6, 1, 6 (20) (III)
- Mais other peut comprendre et jouer mystique (son 1) et alors :
    - Other: 2, 3, 4, 5 (14) (II)
    - Mystique: 1, 6, 1, 6 (14) (II)
- Égalité plutôt qu’échec

Cette configuration est bien sûr idéale. C'est un cas d'école qu’on raconte dans les universités lunaires et qui montre les échanges de proportions à l'œuvre dans le cosmos et la possibilité d'équilibre si on accepte de changer de perspective.

> Note: avant l'Illumination, les Lunaires parlent de l'Etincelle. C'est une façon de percevoir l'Illumination, de l'entrevoir sans pour autant que celle-ci soit totalement intégré et change de manière radicale le cadre de pensée de celui ou celle qui le vit.
---

# Les Quêtes Héroïques
On sait depuis Herowars qu'il faut:

- Accéder à l’Autre Côté
- Réaliser les étapes d'un mythe
- Cela peut être la possibilité suivant la réussite de son entrée dans l’Autre Côté d’accéder au mode héroïque de résolution de son cadre de pensée (avec en face des entités qui eux aussi ont ce mode)

Le système permet de déterminer les résultats de chaque étape. On peut donc narrativement déterminer un niveau de victoire de la quête. Et la narration doit surtout servir à décrire les effets sur le monde réel. 

En effet, selon le niveau de victoire, et selon les actes réalisés pendant la quête, il en découle des conséquences sur les héros et le monde.  Le tout en parallèle parfois.

Quelques aspects des quêtes héroïques: 

- Les changements sont durables
- Il y a des surprises
- On met en gage une aptitude souvent avant de commencer
- Il y a synchronicité entre le monde divin et le monde réel (dans un sens comme dans l’autre).
- Les héros ont intérêt à suivre le chemin du mythe. Mais il est possible de s’en écarter à ses risques et périls.
- Les mythes façonnent la réalité. Le chemin du mythe explique et confirme pourquoi les choses réelles se passent comme ca. Donc si on s’écarte du chemin, on peut changer la réalité du réel!
- Des [couleurs runiques](../../notes/runic-colors) plus marquées
...
| --- | --- | --- | --- |
| 1 | Mouvement | Découverte | ce qui est autour, le monde, lieux, informations… |
| 2 | Mort | Menace | ce qui est différent, l’autre, l’ennemi… |
| 3 | Harmonie | Relations | ce qui relie, émotions, sentiments, liens, dilemme… |
| 4 | Stase | Loi | ce qui est figé, moralité, société, groupe, autorité… |
| 5 | Vie | Ressources | ce qui est nécessaire, matériel, réalité… |
| 6 | Désordre | Révélation | ce qui surprend, bouscule, rebondissement, surprise, ce qui est hors-norme, improbable… |
| 7 | Vérité | Savoir, Connaissance | ce qui doit être cherché, recherché, étudié… |
| 8 | Illusion | Mystère | ce qui est caché, tromperie, illusion, vain, illusoire… |
...
# Spirit bag pour les animistes?
On pourrait même envisager de remplacer les mises par des cailloux, des os, des bouts de bois à piocher dans un sac contenant: 

- 1/6 d’objets marqués avec 3 runes de l’esprit en rouge (les 6)
- 2/6 d’objets marqués avec deux runes de l’esprit pour les 4 et une rune de l'esprit pour les 2 (en rouge)
- 2/6 d’objets sans marque ou avec des coches ou des couleurs (noir pour le 5 et vert pour le 3)
- 1/6 d’objets marqués avec la rune de l’esprit ou la rune de Mort en blanc (les 1)

Il faudrait beaucoup d’objets similaires pour éviter la “triche” et aussi pour ne pas avoir à remiser à chaque recherche d’un lien. Nombre à prévoir: 60 couvre de manière équivalente à 10 mises (il y a bien 10 éléments de chaque en fait).
---
...
La rune de l’infini est une jauge. Seul un vrai dragon peut parcourir
la rune comme un ruban de moebius et obtenir le niveau désiré de
l’infiniment petit à l’infiniment grand. Malheureusement, nous,
humains, ne pouvons faire de même. La rune est alors une contrainte.
(En terme de jeu, c’est le niveau de rune qui est alors la jauge).

En regardant la rune de l’infini, on comprend mieux comment ça
marche:

![Rune de l'infini](/home/dev/projects/glorantha-perspectives/content/rules/draconic/ars-draconis-magica/../../runes/assets/conditions/infini-coordinates.png)

Au centre l’Ouroboros (0). Un point. Un
rond. Un mouvement reptilien et le cercle se plie pour créer la
rune. L’amplitude maximale de la rune est égale à la taille de
cette dernière (1-0-6). Le dragon peut aller vers 1 ou vers 6. Du
fait de sa nature reptilienne, il peut créer de petites amplitudes
commes des grandes. Il y a toujours 4 voies vers les 2 choix
possibles: 1 choix par voie. Le dragon a le choix.

Pour les humains c’est différent, pas de mouvement reptilien (même si
les écoles de Kralorela ont essayé avec les arts martiaux de
simuler ces mouvements pour maitriser l’amplitude de la rune ainsi
qu'Orlanth Larnsting lorsqu'Orlanth était encore l'ami des Dragons).
Et donc le magicien draconique se retrouve confronter à vouloir atteindre un des points du cercle (son objectif) mais en cas d'échec (et même de succès) à se retrouver sur un autre point et surtout au milieu du gué (les points 2,3,4 ou 5)

La magnitude dépend du succès ou de l'échec (nombre de réussites) et de l'enjeu (nombre de mises ou autre)

A titre d’exemple pour la Temporis Magica, la magnitude
peut déclencher des effets sur 1 semaine, 1 mois, 1 an, 10 ans, etc... 

Quand on est au milieu du gué, on observe un effet mais souvent, on perd quelque chose dans l’opération (la vie, une rune, un objet, un souvenir... ).

Cette magie n'est vraiment pas facile à maîtriser. Peu s'y risquent. 

# Temporis Magica

Cette magie draconique vient d’Ouroboros le dragon cosmique et permet de
manipuler le temps.

Une des premières applications est bien sûr le voyage dans le temps.

“Au centre de l’infini, le présent. D’un côté les trois passés,
de l’autre les trois futurs.”

# Res Magica

Cette magie permet de transformer une pensée, un concept en objet ou vice
versa. Les dragons étant plutôt des êtres spirituels, ils
cherchent plutôt la réification de leurs rêves et de leurs
concepts. Mais conformément à la rune de l’infini, l’inverse
est possible aussi. L’usage de la réification développe par
contre le matérialisme (le Wyrm) chez le pratiquant. Pensez a ces armées de
mercenaires dragonewts engagés par les lunaires avec leur or dara
happien.
---
...
# Créer des mythes
Les mythes correspondent à l'histoire pendant le temps des Dieux et ce sont eux qui ont forgé le monde de Glorantha tel qu'il est. 
...
# Exemple de détermination des mises
...
# Les billes mystiques
![marbles](/home/dev/projects/glorantha-perspectives/content/rules/mysticism/mystical-marbles/marbles.png)
...
# Cartes runiques
![cards](/home/dev/projects/glorantha-perspectives/content/rules/theism/runic-cards/cards.png)
...
- L’animisme est celui qui apporte le moins de chaos. Il manipule la **NATURE**, il n’innove pas. Le périmètre est borné. Les nouveautés sont plus que rares. Si tout le monde était animiste, le chaos n'existerait pas.
- La logique ne porte pas le chaos en elle, mais peut donner des résultats qui semble chaotiques via l'ampleur de certains résultats : il amène donc de la nouveauté a l’échelle par les **EFFETS**.
- Les cultistes du **Chaos** sont essentiellement théistes (voire animistes) mais pas besoin de règles supplémentaires à mon avis. Les Dieux Chaotiques sont apparus car il y a eu des failles, mais ils respectent les règles habituelles en tant que Dieu (Grand Compromis, etc…)

> Le Chaos doit rester une vision particulière philosophique: un point de vue sur le changement et la nouveauté et sur ce qui est contre-nature et ce qui pervertit.
---
...
Cela peut être super stimulant de trouver les règles pour le nouveau paradigme introduit par l’effet de telle ou telle rune. Il y a même un côté clairement héroïque: ce n’est pas qu'on change le monde mais on change de manière substantielle la façon dont on agit avec le monde ce qui peut au final à grande échelle transformer littéralement le monde. 
...
Votre première source d’inspiration est Glorantha. Documentez-vous. Lisez. Appréciez. Digérez. Discutez. C’est ce qui vous permet de dire: cette chose est possible dans Glorantha ou pas. En sachant qu’il y a des exceptions, souvent, partout. C’est un univers riche et complexe. 

Les mots-clés pour construire des stratégies, des objectifs, des interrogations et bien sûr pour construire ses mises à utiliser dans les oppositions viennent naturellement de la lecture du lore. Les suppléments HW et HQ sont d’ailleurs des modèles du genre avec quasiment aucune stat: du pure lore directement utilisable et beaucoup de suppléments RuneQuest contiennent essentiellement du lore.

Pour autant, vous pouvez aussi vous baser sur l'[inspiration runique](../../rules/runes/inspiration).
---
...
![Répartition des statistiques par cadre de pensée](/home/dev/projects/glorantha-perspectives/content/notes/stats/image.png)
...
La majorité des résolutions se découpe en deux camps. 

Pour autant, rien n’empêche d’imaginer une opposition en N camps. 
...
![Cercle des runes](/home/dev/projects/glorantha-perspectives/content/notes/runes-meditation/../../rules/runes/assets/pouvoirs/power-runes-circle.png)
...
# Thèmes Gloranthiens
Quelques thèmes de la Guerre des Héros mais aussi ancré dans d'autres époques.
...
- La Guerre des Héros oppose **le Cosmos et le Chao**s. Les dieux sont les gardiens de l’Ordre Eternel qu’on appelle le Cosmos. Depuis la création, le Cosmos a été confronté au Chaos, qui rassemble tout ce qui ne s’adapte pas au Cosmos ou ne peut pas exister à l’intérieur. Le Chaos essaie depuis la création de conquérir, de corrompre ou de détruire le Cosmos et l’essence même des dieux est de résister à cette puissance.
...
> Il est possible aussi de jouer avec ces couleurs uniquement pendant les Quêtes Héroïques. 
---
...
Le commerce est l'affaire de certains cultes qui encadrent les échanges. La majorité des gens pratiquent le troc ou utilisent de la petite monnaie.
...
Il peut être pratique de tirer un jour dans le calendrier Gloranthien.

Le calendrier Gloranthien le plus répandu divise l'année en jour, semaine et saison avec une période de 2 semaines appelée le Temps Sacré.
...
> Les Sages Gris Théyalans aiment à réfléchir sur l'ordre des semaines par rapport aux [runes de pouvoir](../runes-meditation) associées.
