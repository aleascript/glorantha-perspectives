    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          link: {type: 'doc', id: 'narratives/prax-adventures/index'},
          items: [
            {
              type: 'category',
              label: t('La Source des Trois Pierres', 'The Three Stones Source'),
              link: {type: 'doc', id: 'narratives/prax-adventures/three-stones-source/index'},
              items: [
                'narratives/prax-adventures/three-stones-source/verbatim',
                'narratives/prax-adventures/three-stones-source/backstage',
              ],
            },
          ],
        },
