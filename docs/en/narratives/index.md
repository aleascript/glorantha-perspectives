...
- [**The Lunar Way**](the-lunar-way/) — four Lunar heroes between Tarsh, Sartar and Prax, first played with HQ/G rules, then with the experiments that gave rise to Glorantha Perspectives.
- [**Adventures in Prax**](adventures-in-prax/) — tales of adventure in Prax, played with the current Glorantha Perspectives rules.
...
- [**Edkored**](edkored/) — a solitary adept of Orlanth from the Wind Maquis, marked by Air, Movement and Death, whose chronicle begins in the Dogbone hills under pressure from Tarshite patrols.
