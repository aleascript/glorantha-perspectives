...
- **Transcript** — the actual play in its real order, word by word and die by die, including table corrections;
- **Story** — the same session told as a continuous story, for readers who want to follow Tal without the game procedures;
- **Time Backstage** — the Situation, Forces and Pressures, what was prepared, what emerged, what was improvised, and how Time reacted;
- **Living Portrait** — Tal's state exactly at the end of the session.
