...
* Dagger combat
* Celestial Pantheon
* **Virtues**: Adaptable, Tolerant, Inclusive, Opposes the Storm Pantheon
* **Relations**: 
...
* Stealth, Spotting
* Observation, Detect lies, Smell a secret
* Extract information
* Memorize
* Coded language 
* **Relations**: 
   - The Secret Phrases (Empire's network of informants who don't know each other but recognize each other using mysterious phrases)
...
* See in the Dark (medallion)

*Orphan from the slums of Raibanth who from a young age became a lunar informant, then a spy, then an Imperial Shadow, solar creations serving the hidden power.
Since the death of Ignifer, he has been sidelined by the Tharkalites of Argenteus, the new Imperial Mask.*
