...
The same outcome may be favoured by Bets coming from several characters with **different Worldviews**.

In that case, the Bets are read according to the Worldview that applies to each, then compatible outputs are brought together on the same side before comparison.

For a character who has integrated several Worldviews, strategy or fiction may determine which one applies to a given Bet. A more complex combination remains imaginable, but it must clearly state how the different readings become comparable.
...
If determining Bets feels too slow for a minor Situation and you only want a quick reading, one could imagine predefined sets such as **2D vs 2D**: innate/acquired against innate/acquired, or asset/handicap against asset/handicap.
...
It would be tempting to ask players to associate a Rune with each Bet.
