...
The Vector does not tell the Protagonists what to do. It simply describes **the world's current movement**.
...
## What might matter depending on the Protagonists
...
- A Protagonist concerned with trade, logistics, or usage rights may instead look first at the road, the cistern, the convoy detour, or the future sharing of water.
- A personal obligation tied to this night — rite, oath, rendezvous, departure — may add a Pressure specific to a Protagonist, but it is not prepared for them in advance.
...
This Promise belongs to the world, not to the Protagonists. It would remain remarkable whoever stood at this spring that night.

Time therefore does not need to lead the Protagonists toward the image. It only needs to know the image exists **if the fiction gives it room to appear**.

## See what the Situation became

This Situation was actually played once. [**Adventures in Prax — The Three Stones Spring**](../../narratives/adventures-in-prax/three-stones-source/index.md) shows one possible transformation of this material: the play Verbatim and Time's Backstage allow preparation and emergence to be compared directly. It is not the "solution" to the Situation.
