...
You would need many marbles to prevent "cheating" and also to avoid having to reshuffle each time you set bets. Number to plan for: 60 provides equivalent coverage for pools of 10 bets (there are indeed 10 of each element).
