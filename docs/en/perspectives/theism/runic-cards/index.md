...
One could replace the dice for Bets with a deck of cards containing:
...
You would need many cards to prevent "cheating" and avoid reshuffling every time runic support is sought. As a reference, 60 cards comfortably support **up to 10 Bets on one side** while keeping ten copies of every possible result. The divine explosion is slightly constrained, but the statistical effect is negligible.
