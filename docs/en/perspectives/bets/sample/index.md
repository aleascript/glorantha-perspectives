...
Here is a concrete example of determining Bets for an opposition in **Glorantha Perspectives**, specifically illustrating the impact of Focus and a Frame Factor.
...
Kallyr might have wanted to use her *Hot-tempered* trait or her status as an *Intimidating Warrior* to pressure the priestess. But that means is closed by the fiction: it does not become a negative Bet; it is simply inadmissible until the Situation changes.
...
**Bets favouring Yanela keeping the relic:**
...
This example shows that a Bet does not mechanically belong to its owner: a weakness of Yanela can favour Kallyr's desired outcome, while a weakness of Kallyr can favour the other one.

### 4. Read reality's answer

The resolution therefore has **4 Bets against 4 Bets**.

The Bets on both sides are read according to **Theism**. Each side rolls four dice, looking for even numbers and explosive 6s. The roll produces **reality's answer** as a number of Successes, then the two answers are compared to determine which outcome prevails.

The Bets do not disappear afterwards: they remain the material the table uses to describe how Yanela yields, resists, hesitates, or transforms the Situation.
