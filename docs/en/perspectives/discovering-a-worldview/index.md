...
The [Worldviews](../worldviews/) presented in **Glorantha Perspectives** describe several deep ways of inhabiting the Cosmos. They do not necessarily form a closed catalogue.

A Heroquest can transform a Protagonist, a cult, a myth, or part of the world. In the most extraordinary cases, it can go further still: it can reveal a way of understanding reality that did not exist before — or that nobody had yet learned to recognize.

This is not simply learning a foreign practice or adopting an already known Worldview.

**It is discovering that the world can answer differently.**

## Disorder — when known categories are no longer enough

In the [Great Cycle of resolution](../resolution/), the rune of **Disorder** marks the moment when a Worldview recomposes the roll according to its own way of reading reality.
...
## A discovery, not a rule invention

Do not begin by looking for an original mechanic.

Begin with what actually happened in the fiction.

Ask:

- what has the Protagonist discovered about the Cosmos?
- what now becomes important to them when a Situation is uncertain?
- what signs, patterns, relationships, or ruptures do they perceive that others do not perceive in the same way?
- what does this Worldview make them hope for, fear, or seek when reality must answer?

Only then should the rule emerge.

It should express this way of thinking strongly enough for the player to feel it in play. If the same mechanic could be given any other theme without changing the experience, the new Worldview is probably not yet clear enough.
...
An insight born during a Heroquest does not necessarily need to become a complete Worldview immediately.
...
A Heroquest can return knowledge, a blessing, a power, an object, or a transformation of the world.

But there may be a deeper achievement still: **returning with a new way for the world to become intelligible**.

The hero does not then directly change everything. They change the relationship through which some things can be perceived, understood, and made possible. If that Perspective spreads, the world itself may eventually be transformed by it.

> **The Protagonist has not returned with a new rule. They have returned with a world for which the old rules are no longer enough.**
