...
Once the uncertainty is framed, the table looks at **what can genuinely weigh on this question**.

This phase gathers steps 5 and 6: identify Frame Factors, then gather the Bets on each side.
