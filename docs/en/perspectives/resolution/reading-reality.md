...
Once the balance is assembled, the table asks the world **what it answers**.

This phase corresponds to step 7: roll the dice, read them according to the applicable Worldview, then compare reality's answers.
