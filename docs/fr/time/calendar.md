...
Il peut être utile de déterminer rapidement un jour du calendrier gloranthien, notamment lorsque le cycle lunaire ou une fête devient important.
...
Lancez **2D20**. Lisez le premier dé, sauf en cas de double.
