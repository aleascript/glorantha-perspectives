...
Ces Portraits montrent moins un « bon format de fiche » que différentes manières de faire apparaître quelqu'un dans Glorantha.

Ils ne constituent pas des modèles obligatoires. Leur organisation varie parce que les mêmes choses ne comptent pas de la même manière pour chacun.
...
Hanya est une Gardienne de Jillaro, guerrière vouée à Hwarin Dalthippa. Elle sert avec une hache à double tranchant, un arc, une armure de mercure qui ne coule pas et un pur-sang.

Son Portrait tient pourtant dans une contradiction plus importante que son équipement : **elle est entièrement investie dans la cause de la Déesse Rouge sans porter la Rune de Lune.**
...
- combat à la grande hache ;
- marche forcée ;
- ne pas dormir ;
- tactique, tir à l'arc, équitation ;
- esthète, peinture de guerre, crâne rasé à la façon de la Lune ;
- **vertus :** honneur, sacrifice, foi sans faille, beauté, Sylila d'abord ;
- **relations :** le fort de la Sœur Conquérante, quelques Boucliers d'Argent.

### Novice de Hwarin Dalthippa

Sa magie est soumise au cycle lunaire.

Hanya a particulièrement retenu de la déesse :

- Route sûre ;
- Voir le long terme ;
- Intimider les barbares ;
- Sentir la faiblesse de l'ennemi ;
...
Peek-ee-peek est une éclaireuse Nomade Sable. Elle porte arc, lance, casque et fétiches, mais la présence la plus importante à ses côtés est **Fta-Ah**, son antilope sable.
...
- ne faire qu'un avec son antilope ;
- mépriser les chevaux et les sédentaires ;
- survivre dans la Désolation ;
- s'orienter ;
- connaître les coutumes, mythes et géographie de Prax ;
- lire les nœuds praxiens ;
- **relations :** sa tribu, son père Paak-le-rusé ;
...
**Antilope Sable — courageuse, rapide, fidèle.**

Fta-Ah n'est pas rangée dans « équipement » : la relation mérite son propre Chapitre de vie.
...
Suivre cette évolution dans [la Route de Talimar](../narratives/talimar-road/index.md) : [Session 0](../narratives/talimar-road/session-0/index.md) puis [Session 1](../narratives/talimar-road/session-1/index.md).

---

## Des Portraits, pas des modèles

Hanya, Peek et Tal n'ont pas la même architecture de Portrait.
