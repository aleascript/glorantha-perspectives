...
Ces formulations expriment actuellement la compréhension personnelle du mythe par Tal. Leur portée magique reste à découvrir en jeu.
...
Aucun état particulier actuellement.
...
Voir aussi l'[Actual Play détaillé](actual-play.md) et le [récit de cette première séance](story.md).
