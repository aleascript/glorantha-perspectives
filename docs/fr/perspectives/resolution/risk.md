...
Avant un tirage, les joueurs doivent comprendre ce qu'une défaite peut réellement coûter.

Il n'est pas nécessaire de détailler tous les résultats possibles. Il faut en revanche annoncer les conséquences qui changeraient fortement la nature de la partie.

## Annoncer le danger

Quelques formulations simples suffisent :
...
## Modifier son intention

Après avoir compris le danger, le joueur peut maintenir son intention ou la réduire.
...
La mort met fin à une manière de suivre un Protagoniste et transforme souvent plusieurs relations autour de lui. Elle mérite donc d'être cohérente avec ce qui était réellement engagé dans la Situation.
...
Une blessure, une perte, un serment brisé ou une disgrâce n'est pas seulement un « malus ». Si la conséquence demeure vraie après la scène, notez-la.
