...
Avant de demander une réponse au réel, quelque chose doit d'abord **mettre la Situation en mouvement**, puis la table doit savoir **ce que ce mouvement peut réellement engager**.

Cette première phase rassemble les étapes 1 et 2 : **Mouvement** pour l'Intention, **Mort** pour les conséquences importantes.
...
À ce stade, la Situation a une direction et les enjeux importants sont visibles. La table peut maintenant [mettre en balance](balance.md) la question précise qu'elle veut poser au réel.
