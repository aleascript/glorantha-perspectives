---
title: "Quêtes héroïques"
---

# Quêtes héroïques

Une Quête héroïque fait entrer les Protagonistes dans un mythe et leur permet d'agir au contact des puissances qui ont façonné Glorantha.

Elle ne se résume pas à rejouer une histoire connue. Suivre le mythe donne un chemin ; les choix faits pendant la Quête peuvent confirmer ce chemin, l'infléchir ou en faire apparaître des conséquences nouvelles.
...
Chaque étape devient une Situation à part entière.
...
Suivre le chemin connu du mythe aide à rester dans une réalité dont les conséquences sont comprises.

S'en écarter est possible lorsque la fiction le permet. C'est aussi là que la Quête devient particulièrement dangereuse : modifier un rôle, refuser un geste attendu ou introduire quelque chose qui n'appartenait pas au mythe peut transformer ce que la Quête produit dans le monde.

Le Temps ne force pas les Protagonistes à « respecter le scénario ». Il fait vivre les conséquences de leurs actes dans un espace où les mythes ont une réalité propre.

## Ce qui revient de la Quête

Les conséquences d'une Quête héroïque peuvent toucher en même temps :

- les Protagonistes ;
- leurs relations et leurs communautés ;
- un lieu ;
- un culte ;
...
Glorantha contient déjà de nombreux mythes utilisables. Les outils détaillés de préparation seront consolidés dans la section [Le Temps](../../facilitating/).
