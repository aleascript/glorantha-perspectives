...
- **L'Effet Immédiat (L'Annihilation)** : à l'instar des règles de la Vision du monde [Mystique](../mysticism), les « 1 » tirés par le joueur font disparaître les « 6 » de la vision adverse, et disparaissent en même temps. Cette action peut renverser l'issue d'un conflit qui semblait perdu d'avance.
...
L'Illumination peut émerger naturellement dans une configuration de dés très spécifique. L'idée sous-jacente, c'est que l'autre vision comprend (voire se met à jouer les 1 de manière mystique) pour remporter la victoire ou arriver à égalité. Les configurations sont donc plus larges que les deux cas d'école présentés juste après, qui correspondent chacun à un état différent : l'Étincelle et l'Illumination.

## L'éclairante stupéfaction : la source de l'Étincelle

> L'autre vision fait un tirage qui aurait dû écraser le mystique, mais les règles mystiques finissent par inverser totalement le résultat. La stupeur ressentie peut faire naître l'Étincelle.
...
> L'autre vision se retrouve en position de pouvoir jouer un coup mystique pour changer le résultat final. Si elle le fait — le choix du « 1 » — elle épouse l'Illumination.
