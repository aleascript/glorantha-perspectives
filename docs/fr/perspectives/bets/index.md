...
Avant le jet, les joueurs doivent pouvoir connaître les conséquences significatives auxquelles leur décision les expose lorsqu'elles ne sont pas évidentes.

Il ne s'agit pas d'annoncer tout ce qui pourrait arriver. Il s'agit de permettre un choix éclairé depuis la Situation du Protagoniste.
...
Le **Zoom** précise l'échelle de cette question : un geste, une Séquence entière ou un Script plus vaste.

Le Zoom ne règle pas la difficulté. Il détermine quelles différences la fiction souhaite encore distinguer. À l'échelle d'un groupe, une même difficulté collective ne devient pas plusieurs Mises simplement parce qu'elle touche plusieurs Protagonistes.

Voir aussi [Action, Séquence et Script](../resolution/scale.md).

## 3. Regarder ce qui compte

Une **Mise** est une vérité fictionnelle que la table rend pertinente pour le Focus présent.

Elle peut provenir :

- d'une qualité ou d'une expérience du Protagoniste ;
- d'une relation ;
- d'une arme, d'un outil ou d'une ressource ;
- d'une blessure, d'une peur ou d'une obligation ;
- d'un avantage du terrain ;
...
Dans une Séquence plus vaste, elles peuvent devenir distinctes si elles pèsent réellement sur des dimensions différentes.

> **Une Mise compte une fois par dimension pertinente au Focus, pas une fois par formulation ni une fois par personnage.**
...
## 5. Respecter les Facteurs Cadres

Certaines vérités ne donnent pas un dé. Elles définissent ce qui est possible.

Un **Facteur Cadre** peut fermer une Intention, rendre un moyen irrecevable ou imposer une condition tant que la fiction n'a pas changé.
...
Les Mises ne disparaissent pas une fois les dés lancés. Elles fournissent la matière de l'interprétation.
