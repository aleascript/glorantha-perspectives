...
![Mastery](../../../assets/rules/runes/conditions/maitrise.png)![Luck](../../../assets/rules/runes/conditions/chance.png)
...
Principle: facing adversity, we stake everything that could, in this situation, serve us. The adversary or obstacle does the same. And then we proceed to a draw to resolve it.
...
- Each party determines what is important at that moment. By immersing themselves in the world, the situation, the focus they wish, they determine the elements to put on the scale: the **stakes**
- The **resolution** of the stakes is then done with different rules following each camp's vision of the world, depending on whether one is [animist](../animism), [theist](../theism), [mystic](../mysticism) or [logician](../mysticism/index.md). Each camp thus obtains a certain number of successes.
...
The potentially determining stakes are therefore listed.

When there is opposition, it can be useful to define the objectives of each camp and determine the stakes of each camp based on the objectives of one and the other.

A wants this: A+ the stakes that can lead to it, A- the stakes that can thwart A's objective.

B wants this: B+ the stakes that can lead to it, B- the stakes that can thwart B's objective

Opposition → A+, B- vs A-, B+

**Pro-A stakes versus Pro-B stakes**

or alternatively

**Assets, tactics to counter difficulties, dangers of the adversary**

We have the number of **stakes** for each **camp**. We can now proceed to the **resolution**.

Regardless of your character's frame of thought, the method for creating stakes narratively is always the same. The specificity will be found in the acceptable stakes of each party.

### And where does difficulty fit in all this?

First, let us note that certain factors are framework factors. They are so impactful that they force the stakes to align and allow expressing what it will not be possible to attempt.
...
Note: we only switch to a weakened or heroic mode if a framework factor pushes us to do so. Otherwise, it is truly the dynamics of the stakes that are at play. One party will simply have many more dice on their side than the other.
...
- You could materialize hero dice with tokens marked by the Luck rune <img src="../../../assets/rules/runes/conditions/chance.png" width="5%" halign="bottom">, and adversity dice with tokens marked by the Destiny rune <img src="../../../assets/rules/runes/conditions/destin.png" width="5%" halign="bottom"> ("no great destiny without adversity")

> *The Destiny gauge system is inspired by the pass/fail cycle of HQ/G*

> Example:
> - Gauge at 0
> - First conflict: heroes 3 stakes vs adversity 2 stakes -> the gauge gains 1 adversity die (-1)
...
> - Destiny is therefore rather in favor of the heroes. The next conflict could be to their advantage. So if the GM wanted to rebalance everything, they could attempt a conflict with 2 fewer stakes on the adversity side than the heroes' stakes.

### Dice and Stakes

Once the stakes are known for each camp, we lose the link between the stake that created the die and the die. It would be too mentally complex to look at each success of each factor and even more so for Logicians. What matters is the number of successes in the end for each camp.

The frame of thought can serve to express the result following the viewpoint of that frame.

The stakes also serve to determine narrative elements. They become the ingredients of the narration to tell the result of the opposition.

[Example of stake determination](sample)
...
- <img src="../../../assets/rules/runes/formes/homme.png" alt="Man" width="6%"> **Mirror**: the stakes are resolved with the same frame of thought as the non-abstract opponent: this reflects a holistic vision of the world. This is the framework to use when the stakes involve self-transcendence.

- <img src="../../../assets/rules/runes/mondes/median.png" alt="Middle World" width="6%"> **Agnostic**, **Materialist**, **The Middle World**: even numbers (2, 4, 6) will be successes, odd numbers (1, 3, 5) will be failures. There are no other stake adjustment rules once the draw is made. This is the framework to use when the stakes are minor and do not truly involve the character emotionally.
...
If the conflict is not compatible with a status quo, you can redraw by adding one stake to each camp to express the **escalation** linked to the temporary tie during the conflict. This additional stake for each camp represents the will to put an end to it. Escalations can follow one another.

In all cases, the stakes and frames of thought serve the narration of the interpretation.
...
- Fiasco / Feat when the difference between the camps is greater than or equal to 2
